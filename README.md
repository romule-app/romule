...
<p align="center">
  <img src="docs/images/apercu.jpg" alt="The same library on three screens: in a
  desktop browser, where every platform shows at once; on a handheld, where the
  d-pad walks the grid; and on a phone, where the filters fold behind one
  button." width="960">
</p>

<!-- Every picture in this README is generated by `outils/captures.py`, frames
     included, from an invented library — no real title, no third-party
     artwork, nobody's collection. Regenerate them there rather than reaching
     for a screenshot tool: a shot taken from a real installation says what its
     owner has, and ships somebody else's cover art with it. That happened
     twice. -->
...
<td width="50%" valign="top">
  <img src="docs/images/bibliotheque.jpg" alt="The library grid: one card per
  game, each with its size, its platform and badges for updates and DLC.">
  <p align="center"><sub><b>The library</b> — every platform at once, or one at
  a time. Updates and DLC are folded into the game they belong to.</sub></p>
</td>
<td width="50%" valign="top">
  <img src="docs/images/fiche.jpg" alt="A game's detail view: cover, publisher,
  a row of figures, the update it carries, and the files it is made of.">
  <p align="center"><sub><b>A game</b> — what you hold, which version, which
  files, and whether the console has it.</sub></p>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <img src="docs/images/console.jpg" alt="The console settings: the connected
  handheld with its battery and storage, and the folder its games live in.">
  <p align="center"><sub><b>Your console</b> — battery, storage and address,
  read from the console itself. Its games folder is found, not typed.</sub></p>
</td>
<td width="50%" valign="top">
  <img src="docs/images/sante.jpg" alt="The library report: families of problems
  with a count and examples for each.">
  <p align="center"><sub><b>What is wrong</b> — broken files, orphaned DLC,
  duplicates, games with no details, each with what to do about it.</sub></p>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <img src="docs/images/assistant.jpg" alt="The first-start assistant on its
  opening step: what it will ask for, and the interface language.">
  <p align="center"><sub><b>First start</b> — six steps, and one of them has to
  be answered: an unclaimed installation answers everybody.</sub></p>
</td>
