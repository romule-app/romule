...
## Le rapport d'audit et les pages de connexion sont en français
...
Deux choses sortent de ce mécanisme, parce qu'elles ne sont pas construites
...
tout JavaScript, ce qui est tout leur intérêt. Traduire l'une ou l'autre
demande de traduire `romule/audit.py` et les gabarits de page de
`romule/server.py` — une i18n côté serveur, que Romule n'a pas.
