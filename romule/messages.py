...
JQ_AUCUNE_SOURCE = 'aucune source'
JQ_EFFACEES = '%d jaquette(s) effacée(s).'
JQ_INTROUVABLE = 'Aucune jaquette trouvée pour %s.'
JQ_RESUME = 'Jaquettes : %d récupérée(s) (%s), %d sans résultat.'
...
SGDB_CLE_ACCEPTEE = 'Clé acceptée.'
SGDB_CONTACT_KO = 'Contact impossible : %s'
SGDB_REPOND = 'SteamGridDB répond %d.'
...
A_PISTES_JOINTES = '%d fichier(s) de piste joints aux images de disque.'
A_RANGE = 'Rangé : %s → %s/'
...
D_CONSOLE_DEJA_RANGEE = 'Console déjà rangée : rien à déplacer.'
